...
#set_property PACKAGE_PIN T2 [get_ports {d[2]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {d[2]}]
#set_property PACKAGE_PIN R3 [get_ports {d[3]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {d[3]}]
#set_property PACKAGE_PIN W2 [get_ports {u[0]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {u[0]}]
#set_property PACKAGE_PIN U1 [get_ports {u[1]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {u[1]}]
#set_property PACKAGE_PIN T1 [get_ports {u[2]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {u[2]}]
#set_property PACKAGE_PIN R2 [get_ports {u[3]}]					
...
##Pmod Header JB
##Sch name = JB1
#set_property PACKAGE_PIN A14 [get_ports {a[3]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {a[3]}]
##Sch name = JB2
#set_property PACKAGE_PIN A16 [get_ports {a[2]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {a[2]}]
##Sch name = JB3
#set_property PACKAGE_PIN B15 [get_ports {a[1]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {a[1]}]
##Sch name = JB4
...
#	set_property IOSTANDARD LVCMOS33 [get_ports {b[3]}]
##Sch name = JB8
#set_property PACKAGE_PIN A17 [get_ports {b[2]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {b[2]}]
##Sch name = JB9
#set_property PACKAGE_PIN C15 [get_ports {b[1]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {b[1]}]
##Sch name = JB10 
...
##Pmod Header JC
#Sch name = JC1
#set_property PACKAGE_PIN K17 [get_ports {op}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {op}]
##Sch name = JC2
